              ...
              <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                ...
                <li>
                  ...
                  <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                    <li className="w-100">
                      <Link href="http://localhost:3000/admin/datajam">
                        <a className="nav-link px-0">
                          {""}
                          <span className="d-none d-sm-inline">DATA JAM</span>
                          {""}
                        </a>
                      </Link>
                    </li>
                    <li>
                      <a href="http://localhost:3000/admin/createjam" className="nav-link px-0">
                        {" "}
                        <span className="d-none d-sm-inline">Tambah Aksesoris</span>
                      </a>
                    </li>
                  </ul>
                </li>
